...
from espnet.nets.pytorch_backend.asrtts.gumbel_softmax import gumbel_softmax
...
class Decoder(torch.nn.Module):
    ...
    def forward(self, hs_pad, hlens, ys_pad, iteration, strm_idx=0, zero_att=False):
        """Decoder forward
