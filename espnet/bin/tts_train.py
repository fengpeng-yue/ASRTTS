...
def get_parser():
    ...
    parser.add_argument(
        "--warmup-steps", default="20000", type=int
    )
    parser.add_argument(
        "--initial-lr", default="1e-3", type=float
    )
    parser.add_argument(
        "--final-lr", default="1e-5", type=float
    )
    parser.add_argument(
        "--decay-rate", default="0.2", type=float
    )
    parser.add_argument(
        "--decay-steps", default="1000", type=int
    )
    parser.add_argument(
        "--opt", default="adam", type=str, choices=["adam", "noam","lr-decay"], help="Optimizer"
    )
    parser.add_argument(
    ...
    parser.add_argument("--parallel-mode",default='ddp',type=str,
