...
def get_parser():
    ...
    # asr model  (parameter) related
    parser.add_argument(
        "--asr-model", type=str, required=True, help="ASR Model file parameters to read"
    )
    parser.add_argument(
        "--asr-model-conf", type=str, default=None, help="ASR Model config file"
    )
    # tts model  (parameter) related
    parser.add_argument(
        "--tts-model", type=str, required=True, help="TTS Model file parameters to read"
    )
    parser.add_argument(
        "--tts-model-conf", type=str, default=None, help="TTS Model config file"
    )
    parser.add_argument(
        "--num-spkrs",
        type=int,
    ...
    parser.add_argument(
        "--tts-maxlenratio", type=float, default=14, help="Maximum length ratio in decoding"
    )
    parser.add_argument(
        "--tts-minlenratio", type=float, default=0, help="Minimum length ratio in decoding"
    )
    parser.add_argument(
        ...
        if args.backend == "chainer":
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    ...
                    from espnet.asr.pytorch_backend.asrtts import recog
