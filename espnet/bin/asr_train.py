...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        ...
        default="adadelta",
        type=str,
        choices=["adadelta", "adam", "noam","lr-decay"],
        help="Optimizer",
    )
    parser.add_argument(
        "--lr-factor", default=1e-3, type=float, help="Factor for Learning rate"
    )
    parser.add_argument(
        "--final-lr", default=1e-5, type=float
    )
    parser.add_argument(
        "--lr", default=1e-3, type=float
    )
    parser.add_argument(
        "--warmup-steps", default=1000, type=int
    )
    parser.add_argument(
        "--stop-steps", default=20000, type=int
    )
    parser.add_argument(
        "--decay-rate", default=0.5, type=float
    )
    parser.add_argument(
        "--decay-steps", default=12500, type=int
    )
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="init model for pretraining.",
    )
    parser.add_argument(
        "--model-init-json",
        default=None,
        type=str,
        help="init model json for pretraining"
    )
    parser.add_argument(
        "--freeze-mods",
        default=None,
    ...
    parser.add_argument("--test-aug",type=strtobool,default=False,
                        help="test specaugment to joint training")


    # distributed training
    parser.add_argument("--local_rank",default=0, type=int)
    parser.add_argument("--parallel-mode",default='dp',type=str,
                        help="the method of training parallel")
    return parser
